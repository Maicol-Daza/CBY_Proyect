  ...
  useEffect(() => {
    if (cajonSeleccionado) {
      const codigosDelCajon = codigos.filter(codigo => 
        ...
        // Quitar el filtro por estado para mostrar todos los códigos
      );
    ...
    try {
      ...
      const respuesta = await fetch("http://localhost:3000/api/pedidos", {
        ...
        body: JSON.stringify({ 
          ...
          pedido: {
            ...pedido,
            totalPedido: calcularTotalPrendas()
          },
      ...
      <div className="pedido-top">
        ...
        <div className="pedido-form card">
          ...
          <div className="resumen-pedido">
            <p><strong>Total del pedido:</strong> ${pedido.totalPedido.toLocaleString()}</p>
                ...
                {cajones.map((cajon) => {
                  ...
                  return (
                    <div 
                      ...
                      onClick={() => handleSeleccionarCajon(cajon.id_cajon)} // Siempre permitir click
                    >
                  ...
                  {codigosFiltrados.map((codigo) => (
                    ...
                    >
                      <input
                        ...
                        // Quitar disabled para permitir ver todos los códigos
                      />
        ...
        {prendasTemporales.length > 0 && (
          <div className="prendas-lista">
            ...
            <div className="total-pedido">
              <h3>Total del Pedido: ${calcularTotalPrendas().toLocaleString()}</h3>
            </div>
          </div>
        )}
